...
salario = int(input("Por favor digita tu salario mensual (sólo números, no incluyas decimales): "))
...
# return valor_compras_previas

relevancia_antojo = int(input("En una escala de 1 a 5, donde 1 equivale a 'insignificante' y 5 a 'esencial', ¿cómo calificarías tu deseo por este anotjo?: "))
